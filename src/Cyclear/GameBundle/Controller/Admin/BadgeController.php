...
use Cyclear\GameBundle\Entity\Badge;
use Cyclear\GameBundle\Form\BadgeType;
...
class BadgeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CyclearGameBundle:Badge')->findAll();
     ...
     * @Method("POST")
     * @Template("CyclearGameBundle:Badge:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CyclearGameBundle:Badge')->find($id);
     ...
     * @Method("PUT")
     * @Template("CyclearGameBundle:Badge:edit.html.twig")
     */
