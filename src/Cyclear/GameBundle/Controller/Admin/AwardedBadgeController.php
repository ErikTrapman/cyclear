...
use Cyclear\GameBundle\Entity\AwardedBadge;
use Cyclear\GameBundle\Form\AwardedBadgeType;
...
class AwardedBadgeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CyclearGameBundle:AwardedBadge')->findAll();
     ...
     * @Method("POST")
     * @Template("CyclearGameBundle:AwardedBadge:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CyclearGameBundle:AwardedBadge')->find($id);
     ...
     * @Method("PUT")
     * @Template("CyclearGameBundle:AwardedBadge:edit.html.twig")
     */
