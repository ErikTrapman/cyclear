...
return [
    ...
    Ddeboer\DataImportBundle\DdeboerDataImportBundle::class => ['all' => true],
    Doctrine\Bundle\FixturesBundle\DoctrineFixturesBundle::class => ['dev' => true, 'test' => true],
    ErikTrapman\Bundle\CQRankingParserBundle\ErikTrapmanCQRankingParserBundle::class => ['all' => true],
